module Data.TextureAtlas exposing (textureAtlasDecoder, CommonInfo, ImageInfo, TextureAtlas)

import Dict exposing (Dict)
import Http
import Json.Decode as Decode exposing (field, float, index, int, list, string, Decoder)
